...
- `docs/superpowers/specs/2026-07-25-model-custom-contract-design.md`;
- `docs/superpowers/specs/v1.8.3/capability-factory-design.md`;
- `docs/superpowers/specs/v1.8.3/domain-memory-design.md`;
- corrected design commit `ac93be4159a0fcf874dfe77884dc84fa1af6b272`.
