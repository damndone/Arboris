...
**v1.6.12 进度（2026-07-12）**：✅ V1/V2/V3/V5/V6/V8/V10 已实现并已推送；V4 已在本地 closeout 修复并通过独立 legacy `/graph` smoke。V9 已销案(非 bug)。最终 gate：BE 1389/8 skip、golden 23 0-drift、FE 1014、tsc 0。发版流程未走:review→PR→merge main→tag v1.6.12。
