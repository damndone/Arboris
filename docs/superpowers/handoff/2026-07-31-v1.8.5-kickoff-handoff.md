...
- **工作目录**：`/Users/jiayuanren/项目规划/.worktrees/workbench-v1.8.5`
  branch `workbench-v1.8.5`，baseline `9ff0551`，HEAD `76714f0`（仅 docs）。
- **尚未开 FMS 开发线，尚未写任何代码。**
...
git status --short && git log --oneline -1     # 期望：干净，76714f0
...
- [ ] `docs/releases/v1.8.5-release-notes.md`：只写情形 B 的交付；
