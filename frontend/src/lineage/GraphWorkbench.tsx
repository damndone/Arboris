...
export function GraphWorkbench() {
  ...
  // Dismissible per session — no persistence. The dismissal state lives
  // here (component-local) so leaving and returning to the tab resurrects
  // the hint, matching the "session" scope spec §19.4 promises.
  ...
  return (
    ...
    >
      {showLegacyHint && (
        <LegacyStageHint onDismiss={() => setLegacyHintDismissed(true)} />
      )}
