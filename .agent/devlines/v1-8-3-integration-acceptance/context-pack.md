...
## Boundary
- Affected paths: `backend/workbench/app.py`, `backend/workbench/capability_factory`, `backend/workbench/http/notebook_routes.py`, `frontend/src/notebook`, `frontend/src/lineage/drafts`, `tests`
