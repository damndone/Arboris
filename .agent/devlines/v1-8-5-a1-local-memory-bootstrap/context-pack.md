...
Line: `v1-8-5-a1-local-memory-bootstrap`
Baseline SHA: `72f7a2179029127ed47c79ae8e9ffd56d7291d7a`
...
## Boundary
- Affected paths: `backend/workbench/app.py`, `backend/workbench/domain_memory/local_runtime.py`, `backend/workbench/domain_memory/root_resolver.py`, `backend/workbench/domain_memory/scope.py`, `backend/workbench/domain_memory/store.py`, `backend/workbench/domain_memory/service.py`, `backend/workbench/domain_memory/retrieval.py`, `backend/workbench/domain_memory/context_projection.py`, `backend/workbench/http/memory_routes.py`, `backend/workbench/http/notebook_routes.py`, `backend/workbench/agent/notebook/service.py`, `tests/test_domain_memory_local_runtime.py`, `tests/test_domain_memory_root_resolver.py`, `tests/test_domain_memory_routes.py`, `tests/test_notebook_routes.py`, `tests/test_memory_integration_context.py`
- Allowed paths: `backend/workbench/app.py`, `backend/workbench/domain_memory/local_runtime.py`, `backend/workbench/domain_memory/root_resolver.py`, `backend/workbench/domain_memory/scope.py`, `backend/workbench/domain_memory/store.py`, `backend/workbench/domain_memory/service.py`, `backend/workbench/domain_memory/retrieval.py`, `backend/workbench/domain_memory/context_projection.py`, `backend/workbench/http/memory_routes.py`, `backend/workbench/http/notebook_routes.py`, `backend/workbench/agent/notebook/service.py`, `tests/test_domain_memory_local_runtime.py`, `tests/test_domain_memory_root_resolver.py`, `tests/test_domain_memory_routes.py`, `tests/test_notebook_routes.py`, `tests/test_memory_integration_context.py`
- Protected paths: none
- Dependencies: `v1-8-5-typed-memory-model-family`, `v1-8-5-workflow-memory-integration`
- Tests: `tests/test_domain_memory_local_runtime.py`, `tests/test_domain_memory_root_resolver.py`, `tests/test_domain_memory_routes.py`, `tests/test_notebook_routes.py`, `tests/test_memory_integration_context.py`
- Known gates: `local memory root must not follow symlinks or become unsafe temporary storage`, `client-provided memory scope is not authority; server resolves canonical project scope`, `missing or corrupt local store fails closed without blocking normal notebook operation`, `full gate requires stopping any user-owned Vite service and a non-nested Seatbelt host`
