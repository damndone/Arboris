...
## Boundary
- Affected paths: `docs/superpowers/specs/2026-08-01-v1.8.6-predictive-research-correctness-foundation-design.md`, `docs/superpowers/plans/2026-08-02-v1.8.6-predictive-research-foundation-plan.md`, `backend/workbench/predictive_research`, `backend/workbench/prediction.py`, `backend/workbench/artifacts.py`, `backend/workbench/domain.py`, `backend/workbench/statistical_tests.py`, `backend/workbench/engine/capabilities.py`, `backend/workbench/engine/stages/diagnostics.py`, `backend/workbench/orchestrator/__init__.py`, `backend/workbench/agent/context_compiler.py`, `backend/workbench/agent/context_tools.py`, `backend/workbench/agent/notebook/artifact_contract.py`, `backend/workbench/agent/notebook/vocabulary.py`, `backend/workbench/report_contract.py`, `backend/workbench/report_view_model.py`, `frontend/src/runForm/PredictionControls.tsx`, `frontend/src/runResult/PredictionResultCard.tsx`, `frontend/src/runResult.tsx`, `frontend/src/runForm`, `frontend/src/runResult`, `tests/predictive_research`, `tests/test_prediction_models.py`, `tests/test_prediction_request.py`, `tests/test_statistical_tests.py`, `tests/test_statistical_tests_extended.py`, `tests/test_statistical_tests_v186.py`, `tests/test_artifacts.py`, `tests/test_agent_context_tools.py`, `tests/test_report_contract.py`, `tests/test_report_view_model.py`
