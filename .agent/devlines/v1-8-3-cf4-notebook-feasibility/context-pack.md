...
Line: `v1-8-3-cf4-notebook-feasibility`
Baseline SHA: `220ad553b9168a36bb311a54175f01244e76ae36`
...
## Boundary
- Affected paths: `backend/workbench/contracts/agent/notebook_option.py`, `backend/workbench/agent/notebook/recommendation.py`, `tests/test_notebook_recommendation.py`, `tests/contracts/test_v181_contract_lock.py`
- Allowed paths: `backend/workbench/contracts/agent/notebook_option.py`, `backend/workbench/agent/notebook/recommendation.py`, `tests/test_notebook_recommendation.py`, `tests/contracts/test_v181_contract_lock.py`
- Protected paths: `backend/workbench/capability_factory/dispatch.py`, `backend/workbench/capability_factory/supervisor.py`, `backend/workbench/http`, `frontend/src`
- Dependencies: `docs/superpowers/specs/2026-07-25-v1.8.3-capability-factory-design.md`, `.agent/devlines/v1-8-3-cf4-notebook-planner-projection-r1/RETROSPECTIVE.md`, `backend/workbench/agent/notebook/recommendation.py`
- Tests: `PYTHONPATH=backend .venv/bin/pytest -q tests/test_notebook_recommendation.py tests/contracts/test_v181_contract_lock.py`, `PYTHONPATH=backend .venv/bin/pytest -q tests/test_no_exercise_specific_naming.py`
