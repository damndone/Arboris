...
Line: `v1-8-3-implementation-planning-review`
...
## Boundary
- Affected paths: `task_plan.md`, `findings.md`, `progress.md`, `docs/superpowers/plans/v1.8.3`
- Allowed paths: `task_plan.md`, `findings.md`, `progress.md`, `docs/superpowers/plans/v1.8.3`
- Protected paths: `backend`, `frontend`, `scripts/gate.sh`, `docs/superpowers/specs`, `.agent/devlines/v1-8-3-b0-runtime-implementation`
- Dependencies: `docs/superpowers/specs/2026-07-25-model-custom-contract-design.md`, `docs/superpowers/specs/v1.8.3/README.md`, `docs/superpowers/specs/v1.8.3/capability-factory-design.md`, `docs/superpowers/specs/v1.8.3/domain-memory-design.md`, `.agent/devlines/v1-8-3-b0-runtime-implementation/context-pack.md`
- Tests: `PYTHONPATH=backend .venv/bin/pytest -q tests/test_no_exercise_specific_naming.py`, `LC_ALL=en_US.UTF-8 LANG=en_US.UTF-8 .venv/bin/python scripts/devline_control.py verify --line v1-8-3-implementation-planning-review`
- Known gates: `This line may write only review scratch files and docs/superpowers/plans/v1.8.3; it must not modify product code or frozen design specs.`, `The B0 implementation line remains independent and its allowed/protected paths must not be expanded by this planning line.`, `Use LC_ALL=en_US.UTF-8 and LANG=en_US.UTF-8 for Python commands under the repository path.`, `Do not push, open a PR, merge, tag, or release without explicit user authorization.`
