...
Line: `v1-8-3-cf3-validation-runtime`
Baseline SHA: `40eb96867c4e823e330226e422f617bcba448bbf`
...
## Boundary
- Affected paths: `backend/workbench/capability_factory/candidate_store.py`, `backend/workbench/capability_factory/provenance.py`, `backend/workbench/capability_factory/validation_protocols.py`, `backend/workbench/capability_factory/validation_ledger.py`, `backend/workbench/capability_factory/validation_service.py`, `backend/workbench/capability_factory/implementation_sealer.py`, `backend/workbench/capability_factory/evidence_assessment.py`, `backend/workbench/capability_factory/trace_contracts.py`, `backend/workbench/agent/capability_authoring.py`, `backend/workbench/agent/risk.py`, `tests/test_capability_candidate_store.py`, `tests/test_capability_evidence_provenance.py`, `tests/test_capability_validation_protocols.py`, `tests/test_capability_validation_ledger.py`, `tests/test_capability_validation_service.py`, `tests/test_capability_implementation_sealer.py`, `tests/test_capability_evidence_assessment.py`, `tests/test_capability_authoring_risk.py`, `tests/test_capability_validation_trace.py`
...
- Dependencies: `v1-8-3-cf3-adapter-validation`, `v1-8-3-cf2-dependency-bundles`, `v1-8-3-b0-runtime-implementation`
- Tests: `LC_ALL=en_US.UTF-8 LANG=en_US.UTF-8 PYTHONPATH=backend .venv/bin/pytest -q tests/test_capability_candidate_store.py tests/test_capability_evidence_provenance.py tests/test_capability_validation_protocols.py tests/test_capability_validation_ledger.py tests/test_capability_validation_service.py tests/test_capability_implementation_sealer.py tests/test_capability_evidence_assessment.py tests/test_capability_authoring_risk.py tests/test_capability_validation_trace.py`, `git diff --check`, `LC_ALL=en_US.UTF-8 LANG=en_US.UTF-8 PYTHONPATH=backend .venv/bin/python -m compileall -q backend/workbench/capability_factory backend/workbench/agent`, `LC_ALL=en_US.UTF-8 LANG=en_US.UTF-8 PYTHONPATH=backend .venv/bin/pytest -q tests/test_no_exercise_specific_naming.py`
- Known gates: `link-shared-deps requires an absolute worktree path before valid gate claims`, `sandbox-exec sandbox_apply Operation not permitted on this managed macOS host; classify as unsupported host, not product pass`, `npx tsc output must not be piped before reading exit status`, `CF3 must remain generic and must not execute, import, install, network, or access user data`, `E2/E3 requires independent oracle or service holdout; author expected output is not authority`
