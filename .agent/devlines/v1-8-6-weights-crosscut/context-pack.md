...
## Boundary
- Affected paths: `docs/superpowers/plans/2026-08-03-v1.8.6-weights-crosscut-objective.md`, `backend/workbench/domain.py`, `backend/workbench/orchestrator/__init__.py`, `backend/workbench/econometrics/runner.py`, `frontend/src/runForm/RunForm.tsx`, `frontend/src/runForm/RunForm.test.tsx`, `tests/test_ols_weights_v186.py`
- Allowed paths: `docs/superpowers/plans/2026-08-03-v1.8.6-weights-crosscut-objective.md`, `backend/workbench/domain.py`, `backend/workbench/orchestrator/__init__.py`, `backend/workbench/econometrics/runner.py`, `frontend/src/runForm/RunForm.tsx`, `frontend/src/runForm/RunForm.test.tsx`, `tests/test_ols_weights_v186.py`
